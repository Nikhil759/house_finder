...
export default function Toast({ toast, onDismiss, onSignIn }) {
  ...
  const isFirstSave = toast.type === 'first_save'
  const isThreeSaveNag = toast.type === 'three_save_nag'
          ...
          <>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, minWidth: 0 }}>
              ...
              <span style={{
                ...
                You've saved 3 listings — sign in to keep them safe and get new listings in your interest areas.
              </span>
            </div>
